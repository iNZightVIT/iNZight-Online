help.single.column.plots = function(){
  helpModal('Single column plot','single_column_plot',inclMD("gui-elements/notes/single.column.plot.md"))
}
...
get.single.col.sidebar =  function(){
  ...
  list(helpText("Select a column from the dropdown menu to display a approproate plot of the selected column."),
       selectInput("select.column.plot","Select Column",choices=choices1,multiple=F,selectize=T,selected=choices1[1]),
